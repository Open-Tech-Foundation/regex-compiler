...
export default function ReferenceGuide() {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={() => (isOpen = false)} title="Reference Guide" size="xl">
                          ...
                          {(() => {
                            ...
                            try {
                              ...
                              while ((match = re.exec(text)) !== null) {
                                ...
                                parts.push(
                                  <mark className="bg-blue-500/30 text-blue-200 rounded px-0.5 border-b-2 border-blue-500/50">
                                    {match[0]}
                                  </mark>,
                                );
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        {activeItem.details.map((detail, dIdx) => (
                          <div
                            key={dIdx}
                            className="flex items-start gap-4 p-4 bg-[#09090b] border border-zinc-800 rounded-xl group/detail hover:border-zinc-700 transition-colors"
                          >
