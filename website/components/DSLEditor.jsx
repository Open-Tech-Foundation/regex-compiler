...
export default function DSLEditor({ value, error, issues, onChange, onOpenLibrary, onReset }) {
  return (
    <div
    ...
    >
      <div className="flex items-center justify-between px-6 py-4 border-b border-[#27272a] bg-[#121214] shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            onclick={onReset}
            className="px-4 py-1.5 bg-[#09090b] border border-[#27272a] hover:border-zinc-700 text-zinc-400 hover:text-zinc-200 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-all active:scale-95 cursor-pointer"
